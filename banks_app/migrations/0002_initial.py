# Generated by Django 5.0.3 on 2024-05-06 08:17
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foundation_date', models.DateField(default=datetime.date(2024, 5, 6), validators=[banks_app.models.check_created])),
            ],
            options={
                'verbose_name': 'bank',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.CharField(max_length=10, validators=[django.core.validators.RegexValidator(message='Phone number must be 10 digits in total.', regex='^\\+7\\d{10}$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('transaction_date', models.DateField(default=datetime.date(2024, 5, 6), validators=[banks_app.models.check_created])),
